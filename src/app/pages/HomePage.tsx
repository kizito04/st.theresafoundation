...
export default function HomePage() {
  ...
  return (
    <div className="bg-white overflow-hidden">
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 items-center">
            {/* Left Photo: Flies in from Left */}
            <AnimatedSection variant="fly-left" duration={850} className="md:col-span-5 flex justify-center">
              <img
            ...
            {/* Right Text: Flies in from Right */}
            <AnimatedSection variant="fly-right" duration={850} delay={150} className="md:col-span-7 space-y-4">
      ...
      {/* ── Community Impact & Shared Values ── */}
      <section className="py-8 pb-16 lg:pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mt-14 pt-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
              {/* Column 1: Community Impact (Flies in from Left) */}
              <AnimatedSection variant="fly-left" duration={850} className="flex flex-col items-center text-center">
              ...
              {/* Column 2: Shared Values (Flies in from Right) */}
              <AnimatedSection variant="fly-right" duration={850} delay={150} className="flex flex-col items-center text-center">
                <div className="w-16 h-1 bg-blue-600 mb-6 rounded-full" />
                <h3 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight mb-5">
            ...
            <AnimatedSection variant="grow" duration={700} delay={300}>
      ...
      <section className="py-14 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            {/* Left Column: Text (Flies in from Left) */}
            <AnimatedSection variant="fly-left" duration={850} className="lg:col-span-6 space-y-5">
            ...
            {/* Right Column: Image (Flies in from Right) */}
            <AnimatedSection variant="fly-right" duration={850} delay={150} className="lg:col-span-6 flex justify-center">
              <img
                src="/images/Fr with pupils 1.png"
                alt="Murubya Pupils with Director Rev. Fr. Paul Bigirwa"
      ...
      <section className="py-16 sm:py-24 bg-white border-t border-slate-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Section Heading (Grows in) */}
          <AnimatedSection variant="grow" duration={750} className="text-center mb-10 sm:mb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            {/* Left Column: Featured Article (Flies in from Left) */}
            <AnimatedSection variant="fly-left" duration={850} className="lg:col-span-6 space-y-4">
            ...
            {/* Right Column: Two stacked cards (Flies in from Right) */}
            <AnimatedSection variant="fly-right" duration={850} delay={150} className="lg:col-span-6 flex flex-col justify-between space-y-8 lg:pl-4 lg:border-l lg:border-slate-200">
              {/* Top Item */}
          ...
          {/* Bottom Button (Grows in) */}
          <AnimatedSection variant="grow" duration={750} delay={250} className="text-center mt-12">
            <Link
              to="/news"
