        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pb-10 border-b border-white/25">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-bold text-white tracking-wide underline underline-offset-4 decoration-white/50">
          ...
          <div>
            <h4 className="text-white font-bold text-sm mb-4 uppercase tracking-wider underline underline-offset-4 decoration-white/50">
              Quick Links
            </h4>
