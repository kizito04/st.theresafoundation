            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link to="/about" className="text-slate-300 hover:text-white transition-colors flex items-center gap-1.5">
                  <span className="text-white/60">›</span> About the Founder
                </Link>
              </li>
              <li>
                <Link to="/schools" className="text-slate-300 hover:text-white transition-colors flex items-center gap-1.5">
                  <span className="text-white/60">›</span> St. Theresa Schools
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/transporters" className="text-slate-300 hover:text-white transition-colors flex items-center gap-1.5">
                  <span className="text-white/60">›</span> St. Theresa Transporters
                </Link>
              </li>
              <li>
                <Link to="/gallery" className="text-slate-300 hover:text-white transition-colors flex items-center gap-1.5">
                  <span className="text-white/60">›</span> Photo Gallery
                </Link>
              </li>
              <li>
